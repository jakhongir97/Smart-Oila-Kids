...
final class DeviceRecordingWebSocketService {
    var onRecordingEvent: ((DeviceRecordingWebSocketEvent) -> Void)?
    ...
    private func connectUsingCurrentBase() {
        ...
        let urlString = "\(base)\(AppConfig.websocketTokenPath)/children/device/\(dsn)/recordings/"
    ...
    private let parser = DeviceRecordingPayloadParser()
